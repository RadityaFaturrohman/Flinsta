...
const variants = {
  base: "relative flex justify-center items-center flex-col cursor-pointer transition-colors duration-200 ease-in-out",
  image:
  ...
  accept: "border border-blue-500 bg-blue-500 bg-opacity-10 border-dashed",
